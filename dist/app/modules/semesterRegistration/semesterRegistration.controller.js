...
const createSemesterRegistration = (0, cathcAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const findSemesterRegistration = (0, cathcAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield semesterRegistration_service_1.SemesterRegistrationServices.findAllSemesterRegistrationFromDB(req.query);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const findSingleSemesterRegistration = (0, cathcAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    console.log(id);
    const result = yield semesterRegistration_service_1.SemesterRegistrationServices.findSingleSemesterRegistrationFromDB(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: "semester register is retrieve successfully",
...
const updateSemesterRegistration = (0, cathcAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
