...
exports.validateSemesterRegistrations = void 0;
const zod_1 = require("zod");
const semesterRegistration_constant_1 = require("./semesterRegistration.constant");
const createSemesterRegistrationValidationSchmea = zod_1.z.object({
    body: zod_1.z.object({
...
const updateSemesterRegistrationValidationSchmea = zod_1.z.object({
    body: zod_1.z.object({
...
exports.validateSemesterRegistrations = {
    createSemesterRegistrationValidationSchmea,
    updateSemesterRegistrationValidationSchmea
};
